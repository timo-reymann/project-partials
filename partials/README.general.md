${PROJECT_NAME}
===
[![LICENSE](https://img.shields.io/github/license/timo-reymann/${REPO_SLUG_NAME})](https://github.com/timo-reymann/${REPO_SLUG_NAME}/blob/main/LICENSE)
